...
#define MyAppName "OpenKJ-Tools"
#define MyAppVersion "0.11.15"
#define MyAppPublisher "OpenKJ Project"
#define MyAppURL "https://openkj.org/"
#define MyAppExeName "OpenKJTools.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{D2E14F30-E743-4A06-93B3-863149987023}
AppName={#MyAppName}
...
OutputBaseFilename=OpenKJ-Tools
Compression=lzma
SolidCompression=yes
UninstallDisplayName=OpenKJ-Tools
...
[Files]
Source: "C:\projects\openkj\output\OpenKJTools.exe"; DestDir: "{app}"; Flags: ignoreversion
